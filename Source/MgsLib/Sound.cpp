...
MSG_FUNC_IMPLEX(0x0052269C, Sound_Init, SOUND_IMPL);
MSG_FUNC_IMPLEX(0x005227AD, Sound_HexCharToInt, SOUND_IMPL);
MSG_FUNC_IMPLEX(0x00522BCE, Sound_CleanUpRelated, SOUND_IMPL);
MSG_FUNC_IMPLEX(0x00522466, Sound_CloseWavStopQ, SOUND_IMPL);
MSG_FUNC_IMPLEX(0x00523A44, Sound_CreateBufferQ, SOUND_IMPL);
MSG_FUNC_IMPLEX(0x00522601, Sound_CreatePrimarySoundBuffer, SOUND_IMPL);
MSG_FUNC_IMPLEX(0x00521982, Sound_CreateSecondarySoundBuffer, SOUND_IMPL);
MSG_FUNC_IMPLEX(0x0052236D, Sound_FadeQ, SOUND_IMPL);
MSG_FUNC_IMPLEX(0x005234EA, Sound_GetSamp1PosQ, SOUND_IMPL);
MSG_FUNC_IMPLEX(0x005224BE, Sound_GetSomeStateQ, SOUND_IMPL);
MSG_FUNC_IMPLEX(0x00522A33, Sound_InitFx, SOUND_IMPL);
MSG_FUNC_IMPLEX(0x005227FF, Sound_LoadBufferFromFile, SOUND_IMPL);
MSG_FUNC_IMPLEX(0x00522A9C, Sound_LoadFxRelatedQ, SOUND_IMPL);
MSG_FUNC_IMPLEX(0x00522B8D, Sound_LoadFxRelatedQ2, SOUND_IMPL);
MSG_FUNC_IMPLEX(0x00521A54, Sound_PlayMusic, SKIP);
MSG_FUNC_IMPLEX(0x005231A9, Sound_PlaySample, SOUND_IMPL);
MSG_FUNC_IMPLEX(0x0052307F, Sound_PlaySampleRelated, SOUND_IMPL);
MSG_FUNC_IMPLEX(0x00521F82, Sound_PopulateBufferQ, SOUND_IMPL);
MSG_FUNC_IMPLEX(0x00523A1F, Sound_ReleaseBufferQ, SOUND_IMPL);
MSG_FUNC_IMPLEX(0x00521A18, Sound_ReleaseSecondaryBuffer, SOUND_IMPL);
MSG_FUNC_IMPLEX(0x00523B2C, Sound_RestoreRelatedQ, SOUND_IMPL);
...
MSG_FUNC_IMPLEX(0x005226EB, Sound_ShutDown, SOUND_IMPL);
MSG_FUNC_IMPLEX(0x00523232, Sound_Start2SamplesQ, SOUND_IMPL);
MSG_FUNC_IMPLEX(0x00523466, Sound_Stop2Samples, SOUND_IMPL);
MSG_FUNC_IMPLEX(0x0052313B, Sound_StopSample, SOUND_IMPL);
MSG_FUNC_IMPLEX(0x00521898, Sound_TableUnknown1, SOUND_IMPL);
MSG_FUNC_IMPLEX(0x0052255B, Sound_SetMusicVolume, SOUND_IMPL);
MSG_FUNC_IMPLEX(0x005224C8, Sound_SetSoundFxVolume, SOUND_IMPL);
MSG_FUNC_IMPLEX(0x00522CB2, Sound_PlayEffect, SKIP);
MSG_FUNC_IMPLEX(0x00523E12, Sound_Unknown4, SOUND_IMPL);
MSG_FUNC_IMPLEX(0x00523CF3, Sound_Unknown5, SOUND_IMPL);
MSG_FUNC_IMPLEX(0x00523CB9, Sound_Unknown6, SOUND_IMPL);
